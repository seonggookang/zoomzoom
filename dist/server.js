...
wss.on("connection", function (socket) {
  ...
  socket.on("message", function (msg) {
    ...
    switch (message.type) {
      ...
      case "nickname":
        // socket이 누군지 알아야하니 socket 안에 넣어줘야함
        socket["nickname"] = message.payload;
      // nickname 프로퍼티를 socket에 넣는코드
    }
